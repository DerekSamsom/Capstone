...
There are `r length(which(appointments$appt_lead_time < 0))` negative values, indicating observations that suggest the appointment was booked after it occurred. THis is an impossible value and must represent entry errors, but the number is small.  These will be replaced with 0.
...
appointments$appt_weekday <- factor(appointments$appt_weekday, levels = c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday"))
...
appointments$weekday_scheduled <- factor(appointments$weekday_scheduled, levels = c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday"))
